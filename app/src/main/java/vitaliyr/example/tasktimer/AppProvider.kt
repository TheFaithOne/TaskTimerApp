...
const val CONTENT_AUTHORITY = "vitaliyr.example.tasktimer.provider"
...
class AppProvider: ContentProvider() {
    ...
    private fun buildUriMatcher() : UriMatcher{
        ...
        //e.g. content://vitaliyr.example.tasktimer.provider/Tasks
        matcher.addURI(CONTENT_AUTHORITY,TasksContract.TABLE_NAME, TASKS)
        //e.g. content://vitaliyr.example.tasktimer.provider/Tasks8
...
//        matcher.addURI(CONTENT_AUTHORITY, "${DurationContract.TABLE_NAME}/#", TASK_DURATIONS_ID)
    ...
    override fun insert(uri: Uri, values: ContentValues?): Uri? {
        ...
        val recordId: Long
        val returnUri: Uri
        val context = context ?: throw NullPointerException("Context cannot be null here")
        ...
        when (match){
            TASKS -> {
                ...
                }else throw SQLException("Insert failed. Uri was: $uri")
            }
            TIMINGS -> {
                val db = AppDatabase.getInstance(context).writableDatabase
        ...
        Log.d(TAG, "Exiting insert function. Returning $returnUri")
        return returnUri
    }
...
//            }
    ...
    override fun update(
        ...
        val context = context ?: throw NullPointerException("Context cannot be null!")
